...
public final class Updater {
  ...
  public static Release getLatestRelease(Environment environment, Log uiLog) {
    if (cachedlatestRelease == null) {
      try {
        ...
        uiLog.warn(
            "Unable to check latest release of HearthStats Companion due to error: "
                + e.getMessage(), e);
      }
    }
  ...
  public static void run(Environment environment, Release release, Log uiLog) {
