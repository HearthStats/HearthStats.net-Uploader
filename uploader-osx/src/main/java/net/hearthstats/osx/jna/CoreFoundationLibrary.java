...
//    NativeLong CFDictionaryGetCount(Pointer cfDictionaryRef);
...
//    Pointer CFDictionaryGetValue(CFDictionaryRef theDict, Pointer key);
//Pointer CFDictionaryGetValue(CFDictionaryRef theDict, String key);
    Pointer CFDictionaryGetValue(CFDictionaryRef theDict, ID key);
//    NSObject CFDictionaryGetValue(CFDictionaryRef theDict, ID key);

    //    Pointer CFDictionaryGetValue(CFDictionaryRef theDict, NSString key);
    boolean CFDictionaryGetValueIfPresent(CFDictionaryRef theDict, Pointer key, PointerByReference value);
//    Pointer CFDictionaryGetValue(Pointer theDict, Pointer key);
//    boolean CFDictionaryGetValueIfPresent(Pointer theDict, Pointer key, PointerByReference value);
