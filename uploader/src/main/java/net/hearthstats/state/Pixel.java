...
public enum Pixel {
    ...
    MATCH_ORGRIMMAR_END_E   (PixelLocation.E,  59,  50,  47, 126, 114, 118),
    MATCH_ORGRIMMAR_END_K   (PixelLocation.K,  39,  26,  25,  82,  66,  59),
    MATCH_ORGRIMMAR_END_L   (PixelLocation.L,  28,  20,  19,  61,  52,  50),
    ...
    MATCH_PANDARIA_END_E    (PixelLocation.E,  76,  63,  61, 150, 145, 142),
    MATCH_PANDARIA_END_K    (PixelLocation.K, 214, 213, 209, 258, 253, 243),
    MATCH_PANDARIA_END_L    (PixelLocation.L,  94,  89,  84, 127, 122, 117),
    ...
    MATCH_STORMWIND_END_E   (PixelLocation.E,  74,  62,  61, 176, 178, 190),
    MATCH_STORMWIND_END_K   (PixelLocation.K,  92,  97, 100, 119, 123, 122),
    MATCH_STORMWIND_END_L   (PixelLocation.L, 121, 128, 132, 146, 153, 157),
    MATCH_STORMWIND_END_R   (PixelLocation.R,  96,  93,  84, 133, 130, 120),

    MATCH_STRANGLETHORN_END_B(PixelLocation.B, 35,  36,  35,  55,  57,  55),
    MATCH_STRANGLETHORN_END_C(PixelLocation.C, 91,  84,  77, 111, 104,  97),
    MATCH_STRANGLETHORN_END_D(PixelLocation.D, 84,  78,  73, 109, 103,  97),
    MATCH_STRANGLETHORN_END_E(PixelLocation.E, 81,  68,  66, 102,  89,  87),
    MATCH_STRANGLETHORN_END_K(PixelLocation.K, 99,  96,  90, 135, 130, 122),
    MATCH_STRANGLETHORN_END_L(PixelLocation.L,150, 146, 135, 170, 167, 156),
    MATCH_STRANGLETHORN_END_R(PixelLocation.R,125, 121, 109, 145, 141, 129),
