...
public class MatchEndPopup extends JPanel {
  ...
  private final MigLayout layout = new MigLayout("", "[]10[grow]20[]10[grow]", "");
  ...
  public static Button showPopup(Component parentComponent, HearthstoneMatch match,
  ...
  private void initComponents() {
    ...
    JLabel heading = new JLabel(match.mode() == null ? t("match.popup.heading") : match.mode()
    ...
    opponentNameField.addKeyListener(new KeyAdapter() {
      ...
      public void keyReleased(KeyEvent e) {
        match.opponentName_$eq(opponentNameField.getText().replaceAll("\\s+", ""));
      }
    });
    ...
    yourClassComboBox.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        if (yourClassComboBox.getSelectedIndex() == 0) {
          ...
          match.userClass_$eq(Constants.hsClassOptions[yourClassComboBox.getSelectedIndex()]);
        }
      }
    });
    ...
    opponentClassComboBox.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        if (opponentClassComboBox.getSelectedIndex() == 0) {
          ...
          match.opponentClass_$eq(Constants.hsClassOptions[opponentClassComboBox.getSelectedIndex()]);
        }
      }
    });
