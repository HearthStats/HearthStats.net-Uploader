...
public class Monitor extends JFrame implements Observer {
    ...
    private JPanel _createOptionsUi() {
        ...
        panel.add( new JLabel( t( "options.label.game.language" ) ), "skip,right" );
        gameLanguageField = new JComboBox<>( new String[] { t( "options.label.game.language.eu" ), t( "options.label.game.language.fr" ) } );
        ...
        panel.add( gameLanguageField, "wrap" );
    ...
    private void _saveOptions() {
        ...
        Config.GameLanguage gameLanguage = Config.GameLanguage.values()[gameLanguageField.getSelectedIndex()];
